...
import ru.practicum.shareit.booking.dto.BookingRequestDto; // Правильный импорт
...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    @Transactional
    public Booking create(BookingRequestDto bookingRequestDto, Long bookerId) {
    ...
    @Override
    @Transactional
    public Booking updateStatus(Long bookingId, Boolean approved, Long ownerId) {
